...
export class BookService{
    ...
    getAllBooks(): Observable<Book[]>{
        ...
        return this._httpService.get("http://localhost:8080/book")
    ...
    getBookById(bookId: string): Observable<Book>{
        ...
        return this._httpService.get("http://localhost:8080/book/"+bookId)
                .map((response: Response) => response.json())
                .catch(this.handleError);
    }
    ...
    addBook(book: Book){
        ...
        if(book.id){    
            ...
            return this._httpService.post("http://localhost:8080/book/", body, options);
        }else{
    ...
    deleteBook(bookId: string){
        ...
        return this._httpService.delete("http://localhost:8080/book/"+bookId);
    }
